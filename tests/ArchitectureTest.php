...
final class ArchitectureTest extends TestCase
{
    ...
    public function testUnkeyedSkipEntryIsTreatedAsRuleSkipWhenRuleAlreadyExists(): void
    {
        $architecture = Architecture::define()
            ->rule('source.must_be_final', new MustBeFinalRule('Source'))
    ...
    public function testUnkeyedSkipEntryIsResolvedToRuleSkipWhenRuleIsAddedLater(): void
    {
        $architecture = Architecture::define()
            ->skip(['source.must_be_final', 'tests/Fixtures/'])
            ->rule('source.must_be_final', new MustBeFinalRule('Source'));
