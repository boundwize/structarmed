...
final readonly class Psr1Preset implements PresetInterface
{
    ...
    public function apply(Architecture $architecture): void
    {
        ...
        $architecture->rule(self::FILES_MUST_USE_VALID_TAGS, new Psr1PhpTagsRule($this->sourcePaths, $phpFileFinder));
        $architecture->rule(self::FILES_MUST_USE_UTF8_WITHOUT_BOM, new Psr1Utf8WithoutBomRule($this->sourcePaths, $phpFileFinder));
        $architecture->rule(
